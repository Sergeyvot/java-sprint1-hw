...
public class Main {
        ...
        while (userInput != 0) {
            if (userInput == 1) {
                results.enterSteps();
                        ...
                        printStatisticOfMonth(statMonth);
                   } else if (userInput == 3) {
                             int basicPurpose = results.targetNumberSteps;
                             results.recordGoal(basicPurpose);
                             newTargetNumberSteps = results.recordGoal(basicPurpose);
                          } else {
    ...
    static void printStatisticOfMonth(int statMonth) {
        StepTracker results = new StepTracker ();
